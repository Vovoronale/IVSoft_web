...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
    'uk': {
      ...
      authorInfo: "Автор проекту: [Ім'я Автора]. Детальніше: <a href='https://www.linkedin.com/in/yourlinkedin' target='_blank' class='ga-link' data-ga-event='linkedin_click'>LinkedIn</a>.",
    ...
    'en': {
      ...
      authorInfo: "Project author: [Author Name]. More info: <a href='https://www.linkedin.com/in/yourlinkedin' target='_blank' class='ga-link' data-ga-event='linkedin_click'>LinkedIn</a>.",
